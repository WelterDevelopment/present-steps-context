...
\usepath[components,pictures,products]
...
\definemeasure[paperheight] [9.9cm]
\definemeasure[paperwidth]  [17.6cm]
\definemeasure[grid]   [0.1cm]
\definemeasure[small]  [0.2cm]
\definemeasure[medium] [0.4cm]
\definemeasure[large]  [0.6cm]
\definemeasure[big]    [0.8cm]
\definemeasure[huge]   [1.0cm]
\definemeasure[zero]   [0.0cm]
\setuplayout[
  topspace=0.2cm,
  backspace=0.4cm,
  width=fit,
